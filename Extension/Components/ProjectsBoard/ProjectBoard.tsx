...
const OnDragEnd = (result, columns, columns_set) => {
...
const ProjectsBoard = (props: {
  ...
  options_set: (ModelDataOptions)
}) => {
  let { options, options_set} = props
  if (options == undefined || options_set == undefined) return null
