...
import ContactForm from "../components/dis";
...
<div class="row">
  <div class="col-lg-8">
    ...
    <div class="card">
      ...
      <div class="row">
        <div class="col-md-2">
          <img src="/theme/{{project.project_thumbnail}}" class="company-logo" />
        </div>
        <div class="col-md-6">
    ...
    <div class="card">
      ...
      <div class="row">
        <div class="col-md-2">
          <img src="/theme/{{ exp.company_logo }}" class="company-logo" />
        </div>
        <div class="col-md-6">
    ...
    <div class="card">
      ...
      <div class="row">
        <div class="col-md-2">
          <img src="/theme/{{ detail.college_logo}}" class="company-logo" />
        </div>
        <div class="col-md-6">
